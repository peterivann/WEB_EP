...
import '../../components/com_page_main_1_admin/component.js'
import {RouterFactory} from "../../router/router.js";

let router = RouterFactory.createInstance();

class PageMain1Admin extends HTMLElement {
    ...
    _render() {
        ...
        top_menu.Setindicator("indicator");

        top_menu.refresh();
    }
}

customElements.define('page-main-1-admin',PageMain1Admin);
